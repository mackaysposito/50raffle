...
async function countTickets() {
    ...
    if (feb > 0) tixSummary = tixSummary.concat("<br>", feb + " tickets in the February drawing");
    if (mar > 0) tixSummary = tixSummary.concat("<br>", mar + " tickets in the March drawing");
    if (apr > 0) tixSummary = tixSummary.concat("<br>", apr + " tickets in the April drawing");
    if (may > 0) tixSummary = tixSummary.concat("<br>", may + " tickets in the May drawing");
    if (jun > 0) tixSummary = tixSummary.concat("<br>", jun + " tickets in the June drawing");
    if (jul > 0) tixSummary = tixSummary.concat("<br>", jul + " tickets in the July drawing");
    if (aug > 0) tixSummary = tixSummary.concat("<br>", aug + " tickets in the August drawing");
    if (sep > 0) tixSummary = tixSummary.concat("<br>", sep + " tickets in the September drawing");
    if (oct > 0) tixSummary = tixSummary.concat("<br>", oct + " tickets in the October drawing");
    if (nov > 0) tixSummary = tixSummary.concat("<br>", nov + " tickets in the November drawing");
    if (dec > 0) tixSummary = tixSummary.concat("<br>", dec + " tickets in the december drawing");
